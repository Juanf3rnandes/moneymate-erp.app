...
const CardContainerPadStyle = css<MMCardProps>`
  ${({ theme, pad }) => {
...
const CardContainerBgStyle = css<MMCardProps>`
...
const CardContainerAccentStyle = css<MMCardProps>`
...
export const CardStyle = styled.div<MMCardProps>`
  display: flex;
